...
namespace TaskbarGroupsClient
{
    public partial class ucCategoryPanel : UserControl
    {
        ...
        public ucCategoryPanel(frmClient client, Category category)
        {
            ...
            picGroupIcon.BackgroundImage = LoadBitmap(@"config\" + Category.Name + @"\GroupImage.png"); //getting icon from file
        ...
        private void CreateShortcut(int x, int y, ProgramShortcut programShortcut)
        {
            ...
            {
                this.shortcutPanel.BackgroundImage = TaskbarGroupsClient.Properties.Resources.Error; 
